...
CREATE TABLE IF NOT EXISTS accounts (
  ...
  -- Nullable: an account created through Google/Apple/Discord has no password
  ...
  email_verified_at BIGINT NULL DEFAULT NULL,
  PRIMARY KEY (id),
...
-- Federated sign-in. One provider account maps to exactly one local account,
...
-- In-flight OAuth handshakes. Keyed here rather than on the session so the flow
-- survives Apple's cross-site form_post callback and the Capacitor handoff.
