...
(function (root, factory) {
  ...
  function foundationCardIRInventory() {
    return {
      ...
      productionMechanismDetection: 'role_tags_and_oracle_heuristics',
      ...
      capabilities: {
        closeGame: {
          ...
          currentlyUnreliable: 'Declared wincon pieces vs IR wincon; combo lines; IR unused for detection',
        },
        manaAccess: {
          ...
          currentlyUnreliable: 'Rocks/dorks/rituals without Ramp tag; IR unused for detection',
        },
        resources: {
          ...
          currentlyUnreliable: 'Impulse/wheel/loot without Card Draw tag; IR unused for detection',
        },
        interaction: {
          ...
          currentlyUnreliable: 'Threat-type split; graveyard hate; IR unused for detection',
        },
        keepGoing: {
          ...
          currentlyUnreliable: 'Keep Going is an outcome of other caps; IR unused for detection',
        },
      },
