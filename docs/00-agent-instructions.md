...
Hybrid suggestion work: current merge is [10-hybrid-suggestions.md](./10-hybrid-suggestions.md). Destination is **Hybrid v2** (Foundation engine). Locks: [15-foundation-interview.md](./15-foundation-interview.md) (round 2), [16-foundation-interview-r3-r5.md](./16-foundation-interview-r3-r5.md) (rounds 3–5). Philosophy: [14-foundation-model.md](./14-foundation-model.md). Do not confuse Hybrid **mode** with Classic `hybridMult` or hybrid mana costs. The Foundation interview is complete. Implementation is in progress (architecture first). Plan: [17-foundation-implementation-plan.md](./17-foundation-implementation-plan.md). Isolate coefficients in `js/foundation/foundation-config.js`. Do not reopen the five-capability model. Calibration harness: [18-foundation-evaluation-lab.md](./18-foundation-evaluation-lab.md). CardIR vs Foundation evidence: [19-foundation-cardir-audit.md](./19-foundation-cardir-audit.md). Mechanism detector + isolated Lab config: [20-foundation-calibration-infra.md](./20-foundation-calibration-infra.md).
