...
**Status:** In progress — architecture first, calibration later. Owner go-ahead 2026-08-23.  
...
1. Map (this file).  
2–3. Domain model + isolated config.  
4. Need generation.  
5–10. Five capability evaluators (different models).  
11–12. Synergy + multi-role.  
13–14. Target proposal + readout.  
15–17. Adds, Cuts, Hybrid slot.  
18–20. Deck suite, calibration, release criteria.
